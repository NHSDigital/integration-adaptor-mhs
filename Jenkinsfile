                            ...
                            steps {
                                dir('pipeline/terraform/mhs-environment') {
                                    ...
                                    sh label: 'Applying Terraform configuration', script: """
                                            ...
                                            -var mhs_outbound_service_minimum_instance_count=1 \
                                            -var mhs_outbound_service_maximum_instance_count=1 \
                                            -var mhs_inbound_service_minimum_instance_count=1 \
                                            -var mhs_inbound_service_maximum_instance_count=1 \
                                            -var mhs_route_service_minimum_instance_count=1 \
                                            -var mhs_route_service_maximum_instance_count=1 \
