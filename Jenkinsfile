                ...
                stage('Outbound') {
                    stages {
                        ...
                        stage('Unit test') {
                            steps {
                                script {
                                    env.SUPPORTED_FILE_TYPES.tokenize(",").each { server ->
                                    echo "File list is: $SUPPORTED_FILE_TYPES"
