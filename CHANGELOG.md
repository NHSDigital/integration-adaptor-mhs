...
- Update all possible Pip packages to their most modern to resolve dependabot security notices. 
- Codebase has also recently been upgraded from Python 3.7 through 3.8 to 3.9
