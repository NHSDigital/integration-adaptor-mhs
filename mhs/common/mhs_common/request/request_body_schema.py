...
_ATTACHMENT_ALLOWED_CONTENT_TYPES_ENV = os.environ.get('SUPPORTED_FILE_TYPES')
_ATTACHMENT_ALLOWED_CONTENT_TYPES = tuple(_ATTACHMENT_ALLOWED_CONTENT_TYPES_ENV.split(","))
