...
## API docs
MHS outbound (which is the API that suppliers use to make requests to the MHS) is [documented](MHS-Outbound.yaml) using
[OpenAPI](https://spec.openapis.org/oas/v3.0.2).
