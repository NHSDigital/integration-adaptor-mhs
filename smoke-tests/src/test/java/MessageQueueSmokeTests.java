...
public class MessageQueueSmokeTests {

    private static final String BROKERS_ENV_VARIABLE = "MHS_INBOUND_QUEUE_BROKERS";
    private static final String BROKERS_DEFAULT_VALUE = "amqp://localhost:5672";
    private static final String USERNAME_ENV_VARIABLE = "MHS_SECRET_INBOUND_QUEUE_USERNAME";
    private static final String USERNAME_DEFAULT_VALUE = "";
    private static final String PASSWORD_ENV_VARIABLE = "MHS_SECRET_INBOUND_QUEUE_PASSWORD";
    private static final String PASSWORD_DEFAULT_VALUE = "";
    private static final String RABBITMQ_CONTAINER_NAME = "rabbitmq";
    ...
    public static void setup() {
        ...
        brokers = EnvVarsUtil.replaceContainerUri(brokers, "amqp", RABBITMQ_CONTAINER_NAME);
    ...
    @Test
    public void expect_MessageQueueIsAvailable() {
