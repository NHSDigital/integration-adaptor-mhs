...
public class OutboundSmokeTest {
    private static final String DEFAULT_SERVER = "http://localhost";
    private static final String HEALTHCHECK_ENDPOINT = "/healthcheck";
    private static final String HEALTHCHECK_PORT_ENV_VAR = "MHS_OUTBOUND_PORT";

    @Test
    public void expect_OutboundIsAvailable() {
        ...
        healthcheckPort.ifPresentOrElse(
            port -> {
                ...
                try (final CloseableHttpClient httpClient = HttpClients.createDefault()) {
                    ...
                    Assertions.fail("Unable to connect to outbound service at: " + uri);
                }

                assertThat(statusCode)
                    .as("Unable to connect to outbound service at: " + uri + ", status code: " + statusCode)
                    .isEqualTo(200);
