...
public class InboundSmokeTest {

    private static final String DEFAULT_SERVER = "http://localhost";
    private static final String HEALTHCHECK_ENDPOINT = "/healthcheck";
    private static final String HEALTHCHECK_PORT_ENV_VAR = "MHS_INBOUND_HEALTHCHECK_SERVER_PORT";

    @Test
    public void expect_InboundIsAvailable() {
        ...
        healthcheckPort.ifPresentOrElse(
            port -> {
                ...
                try (final CloseableHttpClient httpClient = HttpClients.createDefault()) {
                    ...
                    Assertions.fail("Unable to connect to inbound service at: " + uri);
                }

                assertThat(statusCode)
                    .as("Unable to connect to inbound service at: " + uri + ", status code: " + statusCode)
                    .isEqualTo(200);
